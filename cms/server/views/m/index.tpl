...
<body>
<div class="act-bg"><img src="./images/banner.jpg" alt=""></div>
<div class="tac" style="background-color: #b11e28;"><img src="./images/title_hongbao.jpg" alt=""></div>
...
<div class="lottery-area">
  ...
  <div class="tac mt20 group"><img src="./images/activity/title_lottery.png" width="80%" alt=""></div>
