...
module.exports = {
  ...
  "bee": {
    ...
    "releases": {
      "company": {
        ...
        "servers": [
          {
            "baseUrl": "http://192.168.100.67:10204"
          }
        ]
      },
      "promotionx": {
  ...
  sso: {
    login: "http://192.168.100.67:9200/login",
    auth: "http://192.168.100.67:9200/serviceValidate",
    logout: "http://192.168.100.67:9200/logout"
  }
  //"sso": {
