...
addLoadEvent(function(){
    _initScript("/vendor/jquery_1.7.1.min.js",function(){
        jQuery=$.noConflict();
        _initScript(['/vendor/zepto.js'], function(){
            _initScript(['/vendor/scrollbox.js','/lib.js','/rule.js'], function(){
                _initScript('/m/index.js', function(){
                });
            });
        });
    })
